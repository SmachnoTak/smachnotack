export default function Phone() {
  return (
    <div className="flex items-center w-39 justify-between absolute top-107 xl:top-34! xl:right-25! lg:right-25 lg:top-23! lg:text-sm lg:flex-col lg:items-end md:top-20! md:right-20 md:w-39 sm:top-20 sm:right-[10%] sm:w-30">
      <svg
        viewBox="0 0 35 35"
